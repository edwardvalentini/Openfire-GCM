...
<%
    ...
    int gcmhPort = ParamUtils.getIntParameter(request, "gcmhPort", 0);
    ...
    if (save) {
      if (gcmhHost == null || gcmhHost.trim().length() == 0) {
         errors.put("missinggcmhHost", "missinggcmhHost");
      }
      if (gcmhPort == 0) {
         errors.put("missinggcmhPort", "missinggcmhPort");
      }
      if (gcmhSenderId == null || gcmhSenderId.trim().length() == 0) {
         errors.put("missinggcmhSenderId", "missinggcmhSenderId");
      }
      if (gcmhApiKey == null || gcmhApiKey.trim().length() == 0) {
